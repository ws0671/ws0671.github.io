...
export default function Layout({ children }: ILayoutProps) {
  ...
  return (
    <div>
      <div className="sticky top-0 z-50 w-full bg-white/50 px-[150px] text-2xl backdrop-blur-sm max-sm:hidden">
      ...
      <div className="sticky top-0 z-50 w-full bg-white/50 p-5 text-2xl backdrop-blur-sm sm:hidden">
